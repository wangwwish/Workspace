...
import com.wwish.frame.fragment.CustomFragment;
import com.wwish.frame.util.Constant;
...
//            f.setArguments(bundle);
            Fragment f = (Fragment) ARouter.getInstance().build("/test/fragment").navigation();

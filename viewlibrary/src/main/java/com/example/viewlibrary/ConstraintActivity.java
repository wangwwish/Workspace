...
import com.example.viewlibrary.utils.UiUtils;
...
public class ConstraintActivity extends Activity {
    ...
    private void initWidget() {
        ...
        mLike = (FloatingActionButton) findViewById(R.id.fab_like);
        mTop = (FloatingActionButton) findViewById(R.id.fab_top);
        mWrite = (FloatingActionButton) findViewById(R.id.fab_write);
